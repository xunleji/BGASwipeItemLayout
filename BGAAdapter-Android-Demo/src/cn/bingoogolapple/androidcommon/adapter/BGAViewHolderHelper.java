...
/**
 * 作者:王浩 邮件:bingoogolapple@gmail.com 创建时间:15/5/26 17:06
...
public class BGAViewHolderHelper implements View.OnClickListener,
	 ...
	 */
	public void setOnItemChildCheckedChangeListener(
			BGAOnItemChildCheckedChangeListener onItemChildCheckedChangeListener) {
	...
	public void onClick(View v) {
		if (mOnItemChildClickListener != null) {
			if (mRecyclerView != null) {
				mOnItemChildClickListener.onItemChildClick(mRecyclerView, v,
						getPosition());
			} else if (mAdapterView != null) {
				mOnItemChildClickListener.onItemChildClick(mAdapterView, v,
						getPosition());
			}
		}
	}
	...
	public boolean onLongClick(View v) {
		if (mOnItemChildLongClickListener != null) {
			if (mRecyclerView != null) {
				return mOnItemChildLongClickListener.onItemChildLongClick(
						mRecyclerView, v, getPosition());
			} else if (mAdapterView != null) {
				return mOnItemChildLongClickListener.onItemChildLongClick(
						mAdapterView, v, getPosition());
			}
		}
		return false;
	}
		...
		if (mOnItemChildCheckedChangeListener != null) {
			if (mRecyclerView != null) {
				mOnItemChildCheckedChangeListener.onItemChildCheckedChanged(
						mRecyclerView, buttonView, getPosition(), isChecked);
			} else if (mAdapterView != null) {
				mOnItemChildCheckedChangeListener.onItemChildCheckedChanged(
						mAdapterView, buttonView, getPosition(), isChecked);
			}
		}
	}
	 ...
	 * @return
	 */
	public BGAViewHolderHelper setText(@IdRes int viewId,
	...
	public BGAViewHolderHelper setImageDrawable(@IdRes int viewId,
			Drawable drawable) {
		ImageView view = getView(viewId);
	 ...
	 * @return
	 */
	public BGAViewHolderHelper setTextColorRes(@IdRes int viewId,
	 ...
	 * @return
	 */
	public BGAViewHolderHelper setBackgroundRes(@IdRes int viewId,
			int backgroundResId) {
		View view = getView(viewId);
	 ...
	 * @return
	 */
	public BGAViewHolderHelper setBackgroundColorRes(@IdRes int viewId,
	 ...
	 * @return
	 */
	public BGAViewHolderHelper setImageResource(@IdRes int viewId,
