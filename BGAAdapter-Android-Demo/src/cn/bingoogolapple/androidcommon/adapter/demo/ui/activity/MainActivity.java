...
/**
 * 作者:王浩 邮件:bingoogolapple@gmail.com 创建时间:15/5/28 10:23 描述:
 */
@SuppressLint("NewApi")
public class MainActivity extends AppCompatActivity {
	private Class[] mFragmentClasses = new Class[] {
			GridViewDemoFragment.class, ListViewDemoFragment.class,
			RecyclerViewDemoFragment.class, ListChatDemoFragment.class,
			RecyclerChatDemoFragment.class, ListIndexViewDemoFragment.class,
			RecyclerIndexDemoFragment.class };
	...
	private class ContentPagerAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int position) {
			return Fragment.instantiate(MainActivity.this,
					mFragmentClasses[position].getName());
		}
		...
		public CharSequence getPageTitle(int position) {
			return mFragmentClasses[position].getSimpleName().replace(
					"Fragment", "");
		}
	}
