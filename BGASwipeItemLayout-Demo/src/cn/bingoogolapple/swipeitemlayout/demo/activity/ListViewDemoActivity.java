...
/**
 * 作者:王浩 邮件:bingoogolapple@gmail.com 创建时间:15/5/22 10:06 描述:
 */
public class ListViewDemoActivity extends AppCompatActivity implements
	...
	private static final String TAG = ListViewDemoActivity.class
			.getSimpleName();
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
			long id) {
		Toast.makeText(this, "点击了条目 " + mAdapter.getItem(position).mTitle,
	...
	public boolean onItemLongClick(AdapterView<?> parent, View view,
		...
		Toast.makeText(this, "长按了" + mAdapter.getItem(position).mTitle,
				Toast.LENGTH_SHORT).show();
		return true;
	}
	...
	@Override
	public boolean onItemChildLongClick(ViewGroup parent, View childView,
			int position) {
		if (childView.getId() == R.id.tv_item_bgaswipe_delete) {
			Toast.makeText(this, "长按了删除 " + mAdapter.getItem(position).mTitle,
					Toast.LENGTH_SHORT).show();
			return true;
		}
		return false;
